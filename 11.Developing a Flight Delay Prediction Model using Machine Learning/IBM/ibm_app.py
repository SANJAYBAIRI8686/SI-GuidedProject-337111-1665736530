...
API_KEY = "G6IVwCG-P6ei8f1XX-ckc82S83gHrwYpwGU2dhF-w8bm"
...
def predict():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/f976de27-0697-4300-b99f-1e15fffda2ff/predictions?version=2022-04-21', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
